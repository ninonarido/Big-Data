...
3. **Lineitem** : Represents the line items of each order, including information about the ordered part, supplier, quantity, price, shipping dates, and other line item details. ( Note: Lineitem.tbl file is located here --> https://drive.google.com/file/d/1MY_aazh60icGP2zdv-FmLZO8JqRXOVEP/view?usp=drive_link ).
